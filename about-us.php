  ...
  <div class="hdr-top" style="display: none;">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <div class="hdr-top-inr">
            <span>Only <b>$5.06</b> Away From FREE Shipping!</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="sn-block-650">
          ...
          <div class="sn-text-module-center-title sn-text-module-underline-1">
            <p>Shopping Namara is an online store DEDICATED to providing high quality items at a very affordable cost to our customers! Our array of popular products are sold for OVER 50% discounts to our competitors! We focus primarily on beauty tools, jewelry, accessories, shapewear, and travel bags!</p>
            <p>To achieve our goal of providing affordable AWESOME products, we have partnered with overseas manufacturers and fulfill your orders straight from the factory. This enables us to cut out retail costs and get you the products you need at the lowest possible price. We want EVERYONE to have access to great products within their budget!</p>
            <p><strong>Customer Service</strong></p>
            <p>Customer service is our number one priority. If you have any questions on our products, don't hesitate to <a href="#">contact us.</a> One of our employees will reply to you ASAP!</p>
            <p><strong>Pre Sale Support</strong></p>
            <p>If you are unsure about the style, sizing, or have any concerns, just email us at support@shoppingnamara.com.</p>
          </div>
