    ...
    <div class="row">
      <div class="col-md-12">
        <div class="sn-block-650">
          ...
          <div class="sn-text-module-center-title sn-text-module-underline">
            <h2>SHIPPING</h2>
            <p>
              <strong>What are my shipping options? </strong>
              We offer standard shipping world-wide for $4.95. However, we offer FREE worldwide shipping for orders over $75! 
            </p>
            <p>We do offer FREE Worldwide Shipping on ALL ORDERS periodically so look out for this special deal! </p>
            <p>
              <strong>How long will it take to receive my order?</strong>
            </p>
            <p>Our shipping times are us follows.</p>
             <ul>
              <li>For the USA (including Hawaii and Alaska): you should receive your order within 2-4 weeks of placing it.</li>
              <li>For everywhere else: you should receive your order within 3-5 weeks of placing it. The wide range is due to different policies of customs clearance in different countries. Most of our customers get their order within 4 weeks!</li>
            </ul>
            <p>We are a small, independent company so these are guidelines not hard and fast rules! Just contact us if you need an update estimated time of arrival for your order.</p>
          </div>
          <div class="sn-text-module-center-title sn-text-module-underline">
            <h2>RETURNS</h2>
            <p>
              <strong style="display: inline-block;">FOR MOST PRODUCTS:</strong>
              we offer a 30 day return policy. If you would like to return your product just email us and we will provide you with a return address. Please note, you are responsible for return costs.
            </p>
            <p>Please note that due to hygiene reasons, shapewear, underwear, and lingerie is not eligible for refunds unless it is due to a product defect.</p>

            <p>We STRONGLY recommend looking at the sizing guidelines outlines in the product description before purchasing.  If you have questions regarding recommendations, you can simply email us at support@shoppingnamara.com.</p>

            <p><strong>Exchanges</strong></p>
            <p>
              <strong>FOR MOST PRODUCTS:</strong>
              we offer a 30 day exchange policy. If you would like to exchange your product just email us and we will provide you with a return address. Please note, you are responsible for return costs.
            </p>
            <p>Please note that due to hygiene reasons, shapewear, underwear, and lingerie is not eligible <br> for exchanges unless it is due to a product defect.</p>
            <p>We STRONGLY recommend looking at the sizing guidelines outlines in the product description before purchasing.</p>
          </div>
